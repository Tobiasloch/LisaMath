...
#define pot(a, b) _Generic(a, int: pot_long, long: pot_long, float:pow, double: pow)(a,b)
#define quadrat(a) _Generic(a, int: quadrat_long, long: quadrat_long, float:pow, double: pow)(a, 2)
